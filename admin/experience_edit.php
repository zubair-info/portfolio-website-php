...
if (isset($_GET['experience_id'])) {
    $_SESSION['id'] = $_GET['experience_id'];
}
$id = $_SESSION['id'];

$get_query = "SELECT * FROM experiences WHERE id=$id";
                ...
                <div class="col-md-3">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="experience_edit_post.php" method="post">
                                ...
                                <button class="btn btn-success" type="submit">Update experience</button>
                            </form>
