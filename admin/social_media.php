                ...
                <div class="col-md-3">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Social Setting Add Form</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="social_media_post.php" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="" class="text-capitalize">Social Url</label>
                                    <input type="url" name="social_url" class="form-control">
                                    <span class="text-danger" style="color:red;">
                                        <?php
                                        if (isset($_SESSION['error_msg_social_url'])) {
                                            echo $_SESSION['error_msg_social_url'];
                                            unset($_SESSION['error_msg_social_url']);
                                        }
                                        ?>
                                    </span>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="social_icon_search" style="width: 100%;">
                                            ...
                                            ?>
                                                ...
                                                <!-- echo "<option value='strtolower($icon)'>$icon</option>"; -->
                                ...
                                <div class="mb-3">
                                    <label for="" class="text-capitalize">Social Icon</label>
                                    <input type="text" name="social_icon" id="social_icon" class="form-control">
                                    <!-- <span class="text-danger" style="color:red;">
                                        <?php
                                        if (isset($_SESSION['error_msg_social_icon'])) {
                                            echo $_SESSION['error_msg_social_icon'];
                                            unset($_SESSION['error_msg_social_icon']);
                                        }
                                        ?>
                                    </span> -->
                                    <div class="mb-3 overflow-auto" style="height: 200px;">
                                        ...
                                        ?>
                                            ...
                                            <span id="<?= $icon ?>" class="btn_icon btn btn-dark m-2">
                                                <i class="fa <?= $icon ?>"></i>
                                            </span>
                                ...
                                <button class="btn btn-success" name="submit" type="submit">Add Social</button>
                            </form>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?= $count ?></td>
                                            <td><?= $icon['social_url'] ?></td>
                                            <td><i class="fa <?= $icon['social_icon_search'] ?>"></i></td>
                                            <td><i class="fa <?= $icon['social_icon'] ?>"></i></td>


                                            <td>
                                                <?php
                                                if ($icon['active_sts'] == 1) :
                                                ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    if ($icon['active_sts'] == 1) :
                                                    ?>
                                                        <a href="social_media_active.php?social_id=<?= $icon['id'] ?>" class="btn btn-danger"" class=" btn btn-success">active</a>

                                                    <?php
                                                    else :
                                                    ?>
                                                        <a href="social_media_deactive.php?social_id=<?= $icon['id'] ?>" class="btn btn-success">Deactive</a>
                                                    ...
                                                    <a href="social_media_edit.php?social_id=<?= $icon['id'] ?>" class="btn btn-warning">Edit</a>
                                                    <!-- <a href="icon_delete.php?icon_id=<?= $icon['id'] ?>" class="btn btn-danger">Delete</a> -->
                                                    <button value="social_media_delete.php?social_id=<?= $icon['id'] ?>" type="submit" class="delete_btn btn btn-danger"> DELETE</button>
