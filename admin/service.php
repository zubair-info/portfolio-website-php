                        ...
                        <div class="card-body">
                            ...
                            <form action="service_post.php" method="post">
                                ...
                                <!-- <div class="mb-3">
                                    ...
                                    <input type="text" name="social_icon_search" class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    if ($service['active_sts'] == 1) :
                                                    ?>
                                                        <a href="service_active.php?service_id=<?= $service['id'] ?>" class="btn btn-danger"" class=" btn btn-success">active</a>

                                                    <?php
                                                    else :
                                                    ?>
                                                        <a href="service_deactive.php?service_id=<?= $service['id'] ?>" class="btn btn-success">Deactive</a>
