            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Social icon Edit</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-8">
                    <div class="card card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Social Icon Edit</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="social_media_edit_post.php" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" name="social_url" value="<?= $after_assoc['social_url'] ?>" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="social_icon_search" style="width: 100%;">
                                            ...
                                            ?>
                                                ...
                                                <option value="<?= $icons ?>" <?= ($after_assoc['social_icon_search'] == $icons) ? "selected" : "" ?>><?php echo $icons ?></option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="<?= $after_assoc['social_icon'] ?>" name="social_icon" id="social_icon" class="form-control">
                                    <!-- <span class="text-danger" style="color:red;">
                                        <?php
                                ...
                                <button class="btn btn-success" name="submit" type="submit">Update Social</button>
                            </form>
