...
if (empty($skill_caption)) {
    ...
    header('location: design_skill_item_edit.php');
    ...
    $update_query = "UPDATE `design_skills` SET `skill_caption`='$skill_caption',`progress_percent`='$progress_percent' WHERE id=$id";
